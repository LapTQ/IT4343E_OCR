...
def get_base_model2(height, vocab_size):
    ...
    print(x.shape)
    x = _inverted_res_block(x, expansion=4, out_channels=24, kernel_size=5, strides=2, se_ratio=0.25, block_id=2)
    print(x.shape)
    x = _inverted_res_block(x, expansion=3, out_channels=24, kernel_size=5, strides=1, se_ratio=0.25, block_id=3)
    print(x.shape)
    x = _inverted_res_block(x, expansion=3, out_channels=40, kernel_size=5, strides=2, se_ratio=0.25, block_id=4)
    print(x.shape)
    x = _inverted_res_block(x, expansion=3, out_channels=40, kernel_size=5, strides=1, se_ratio=0.25, block_id=5)
    print(x.shape)
    x = _inverted_res_block(x, expansion=3, out_channels=40, kernel_size=5, strides=1, se_ratio=0.25, block_id=6)
    print(x.shape)
    # x = _inverted_res_block(x, expansion=6, out_channels=80, kernel_size=5, strides=(2, 1), se_ratio=0.25, block_id=7)
    x = keras.layers.Conv2D(filters=80, kernel_size=5, strides=(2, 1), padding='same', name='conv_7')(x)
    x = _se_block(x, in_channels=80, se_ratio=0.25, block_id=7)
    # print(x.shape)
    x = _inverted_res_block(x, expansion=2.5, out_channels=80, kernel_size=5, strides=1, se_ratio=0.25, block_id=8)
    print(x.shape)
    x = _inverted_res_block(x, expansion=2.3, out_channels=80, kernel_size=5, strides=1, se_ratio=0.25, block_id=9)
    print(x.shape)
    # x = _inverted_res_block(x, expansion=6, out_channels=112, kernel_size=5, strides=(2, 1), se_ratio=0.25, block_id=10)
    x = keras.layers.Conv2D(filters=112, kernel_size=5, strides=(2, 1), padding='same', name='conv_10')(x)
    x = _se_block(x, in_channels=112, se_ratio=0.25, block_id=10)
    print(x.shape)
    x = _inverted_res_block(x, expansion=6, out_channels=112, kernel_size=5, strides=1, se_ratio=0.25, block_id=11)
    print(x.shape)
    # x = _inverted_res_block(x, expansion=6, out_channels=160, kernel_size=5, strides=(3, 1), se_ratio=0.25, block_id=12)
    x = keras.layers.Conv2D(filters=160, kernel_size=5, strides=(3, 1), padding='same', name='conv_12')(x)
    x = _se_block(x, in_channels=160, se_ratio=0.25, block_id=12)
    print(x.shape)
